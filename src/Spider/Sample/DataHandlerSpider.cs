	...
	public class DataHandlerSpider
	{
		...
		private class Spider : EntitySpider
		{
			...
			protected override void OnInit(params string[] arguments)
			{
				...
				AddRequest(new Request("https://s.taobao.com/search?q=%E5%A6%99%E5%8F%AF%E8%93%9D%E5%A4%9A&imgfile=&js=1&stats_click=search_radio_all%3A1&ie=utf8&sort=sale-desc&s=0&tab=all", new Dictionary<string, dynamic> { { "bidwordstr", "妙可蓝多" } }));
